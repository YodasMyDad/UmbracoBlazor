...
builder.RootComponents.RegisterAsCustomElement<GetUmbracoData>("umbraco-data");
builder.RootComponents.RegisterAsCustomElement<LatestUmbracoTweets>("umbraco-tweets");
builder.RootComponents.RegisterAsCustomElement<SuggestionsExample>("umbraco-suggestions");
